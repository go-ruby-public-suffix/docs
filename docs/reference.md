...
The public API lives at the module root (`github.com/go-ruby-public-suffix/public-suffix`). It is
**Ruby-shaped but Go-idiomatic**: names mirror Ruby's `public-suffix`, while the surface follows
...
```go
import "github.com/go-ruby-public-suffix/public-suffix"
```
...
- **[pkg.go.dev/github.com/go-ruby-public-suffix/public-suffix](https://pkg.go.dev/github.com/go-ruby-public-suffix/public-suffix)**

The module's [README](https://github.com/go-ruby-public-suffix/public-suffix#readme) carries worked
