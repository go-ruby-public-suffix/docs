...
`go-ruby-public-suffix/public-suffix` reimplements Ruby's `public-suffix` in **pure Go, with cgo disabled**. The slice of
...
- any Go program can import `github.com/go-ruby-public-suffix/public-suffix` directly, with no Ruby runtime;
