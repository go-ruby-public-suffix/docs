# go-ruby-public-suffix documentation

**Pure-Go, MRI-faithful Ruby public-suffix (no cgo)**

`go-ruby-public-suffix/public-suffix` is a faithful, pure-Go (zero cgo) reimplementation of Ruby's `public-suffix`,
matching reference Ruby (MRI) behaviour. The module path is
`github.com/go-ruby-public-suffix/public-suffix`.
...
!!! success "Status: pure-Go, CGO=0, differential-tested"
    A faithful pure-Go port of Ruby's `public-suffix`, validated against reference Ruby, at 100%
...
| Repo | What it is |
| --- | --- |
| [`public-suffix`](https://github.com/go-ruby-public-suffix/public-suffix) | the library — Ruby's `public-suffix` in pure Go |
| [`docs`](https://github.com/go-ruby-public-suffix/docs) | this documentation site (MkDocs Material, versioned with mike) |
| [`go-ruby-public-suffix.github.io`](https://github.com/go-ruby-public-suffix/go-ruby-public-suffix.github.io) | the organization landing page (Hugo) |
| [`brand`](https://github.com/go-ruby-public-suffix/brand) | logo and brand assets |
...
Source lives at [github.com/go-ruby-public-suffix/public-suffix](https://github.com/go-ruby-public-suffix/public-suffix).
